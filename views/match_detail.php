        ...
        <div class="p-4 sm:p-6 md:p-8 lg:p-12">
            ...
            <div class="mb-16 max-w-3xl mx-auto">
                ...
                <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-lg relative overflow-hidden">
                    <!-- AI Source Badge - Centered above content -->
                    <?php
                    ...
                    <!-- AI Explanation -->
                    <div class="mt-4 text-center" id="ai-explanation-container">
                        ...
                        <?php elseif ($match['needs_async_ai'] ?? false): ?>
                            <!-- Loading state for async AI -->
                            <div id="ai-loading" class="flex items-center justify-center gap-2 text-zinc-500">
                                <svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span class="text-[10px] font-mono">Generando análisis con Gemini AI...</span>
                            </div>
                        <?php else: ?>
